...
##  Description
**Assurance** est une application Java développée avec **NetBeans** (structure Ant) conçue pour gérer des aspects liés aux assurances (contrats, clients, sinistres, etc.).
