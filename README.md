...
##  Description
**Assurance** est une application Java développée avec **NetBeans** (structure Ant) conçue pour gérer des aspects liés aux assurances (contrats, clients, sinistres, etc.). Bien que le projet n'inclue pas (pour l'instant) de README, il est structuré avec les dossiers habituels :
